...
/**
 * Servlet takes the Dentist Object's fields and allows the dentist to update 
 * them and then updates the database.
 * @author nicho
 */
@WebServlet(name = "dentUpdateServlet", urlPatterns = {"/dentUpdateServlet"})
public class dentUpdateServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            c1.setOffice(request.getParameter("office"));
            c1.updateDb();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(dentUpdateServlet.class.getName()).log(Level.SEVERE, null, ex);
