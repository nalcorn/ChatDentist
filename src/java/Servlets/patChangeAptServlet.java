...
/**
 * Servlet Allows the patient to change the Appointment Object, and then updates
 * the databse.
 * @author nicho
 */
@WebServlet(name = "patChangeAptServlet", urlPatterns = {"/patChangeAptServlet"})
public class patChangeAptServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(patChangeAptServlet.class.getName()).log(Level.SEVERE, null, ex);
